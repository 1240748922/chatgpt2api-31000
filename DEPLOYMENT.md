...
```text
ghcr.io/1240748922/chatgpt2api-31000:sha-26d613e
```
...
默认镜像 `sha-26d613e` 已包含以下新方案和 Sharp 修复。之前的旧稳定镜像 `sha-f6a3f02` 不包含这些负载门控；如果回退旧稳定版，这三项变量不会生效。
...
例如 `sha-26d613e` 表示新维护方案和 Sharp 修复版本，`sha-f6a3f02` 表示新维护方案之前的旧稳定版。然后执行：
