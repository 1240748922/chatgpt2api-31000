...
METRIC_LABELS = {
    ...
    **TOKEN_METRIC_LABELS,
    ...
    "account_snapshot_check_ms": "账号快照检查",
    "account_candidate_total_ms": "候选账号取号",
    "account_token_maintenance_ms": "账号凭据维护",
    "egress_wait_ms": "等待出口",
...
class RealtimeMonitorService:
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        from services.image_upscale_service import image_upscale_snapshot
        ...
        threadpool["runtime_threads"] = active_count()
        threadpool["account_processing"] = account_processing_limiter.snapshot()
        threadpool["image"] = image_threadpool_snapshot()
        threadpool["upscale"] = image_upscale_snapshot()
        threadpool["account_shard"] = account_service.image_shard_snapshot()
        return {
            "updated_at": beijing_now_str(),
