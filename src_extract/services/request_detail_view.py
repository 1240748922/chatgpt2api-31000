...
_TIMELINE_STEPS = (
    ...
    ("account_token_log_ms", "凭据日志提交", "entry", "包含在凭据结果保存内；生图请求计异步入队耗时，不含后台日志写库"),
    ...
    ("upscale_ms", "超分总耗时", "postprocess", "包含排队、处理和回退；不与子项重复相加"),
...
_TIMELINE_WARNING_THRESHOLDS_MS = {
    ...
    "download_ms": 60_000,
    "upscale_ms": 60_000,
    "upscale_queue_ms": 1_000,
    "upscale_exec_ms": 60_000,
    "storage_ms": 60_000,
