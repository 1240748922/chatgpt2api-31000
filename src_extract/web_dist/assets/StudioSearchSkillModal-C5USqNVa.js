import{d as I,o as _,c as K,a as o,t as k,p as H,D as $,f as i,b as l,e as d,O as g,g as h,l as E,r as A,G as m}from"./index-BhEm-7EJ.js";import{_ as y}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{C as G}from"./ConsoleSegmentedTabs-ByZehyp7.js";import{M as U}from"./ModalBody-DbDsAuvM.js";import{M as L,_ as Y}from"./useConfirmDialog-BPwqO30J.js";import{M as z}from"./ModalHeader-DOAbsAT0.js";import{u as R}from"./usePublicRuntimeConfig-B2ANqaLQ.js";import"./settings-CkHUE9aB.js";const x={class:"code-block scrollbar-slim"},M=I({__name:"CodeBlock",props:{content:{}},setup(e){return(t,P)=>(_(),K("pre",x,[o("code",null,k(e.content),1)]))}}),O=y(M,[["__scopeId","data-v-7b183f75"]]);function V(e){return String(e||"").trim().replace(/\/+$/,"")}function v(e){return`${V(e)}/v1/search`}function q(e){const t=v(e.baseUrl);return e.language==="en"?`---
